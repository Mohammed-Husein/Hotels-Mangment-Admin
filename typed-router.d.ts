...
declare module 'vue-router/auto/routes' {
  export interface RouteNamedMap {
    ...
    'hotels': RouteRecordInfo<'hotels', '/Hotels', Record<never, never>, Record<never, never>>,
    'hotels-id': RouteRecordInfo<'hotels-id', '/Hotels/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'hotels-add-hotel': RouteRecordInfo<'hotels-add-hotel', '/Hotels/AddHotel', Record<never, never>, Record<never, never>>,
    'hotels-edit-hotel-id': RouteRecordInfo<'hotels-edit-hotel-id', '/Hotels/EditHotel/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
